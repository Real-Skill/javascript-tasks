...
describe('Express app', function () {
    ...
    before(function () {
        ...
        server = require('../../app/app')().listen(9000);
    ...
    describe('POST /dog', function () {
        ...
        describe('when payload is too large', function () {
            it('should respond with 413 status code', function () {
                var payload = _.cloneDeep(postedDog);
                payload.name = new Array(16).toString();
                return supertest.post('/dog').set('authorization', validHeader).send(payload).expect(413);
            });
        });
